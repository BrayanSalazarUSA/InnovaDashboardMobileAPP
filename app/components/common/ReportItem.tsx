  ...
  return (
    ...
    >
      ...
      <View className="flex-row items-center mt-4 gap-4">
        {followingsCount > 0 && (
          <View className="flex-row items-center">
            <MaterialCommunityIcons name="video-outline" size={17} />
            <Text className="text-[#A67C00] text-xs ml-1">
              {followingsCount} seguimientos
            </Text>
          </View>
        )}
        ...
        {evidencesCount > 0 && (
          <View className="flex-row items-center">
            <MaterialCommunityIcons name="folder-outline" size={17} />
            <Text className="text-[#A67C00] text-xs ml-1">
              {evidencesCount} evidencias
            </Text>
          </View>
        )}

        {incidentLocationsCount > 0 && (
          <View className="flex-row items-center">
            <MaterialCommunityIcons name="map-outline" size={17} />
            <Text className="text-[#A67C00] text-xs ml-1">
              {incidentLocationsCount} ubicaciones
            </Text>
          </View>
        )}
      </View>
