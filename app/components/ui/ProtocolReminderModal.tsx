  ...
  const handleConfirmResponsable = () => {
    ...
    const run = async () => {
      ...
      try {
        ...
        const normalizedMessage = /not pending for this device/i.test(
          rawMessage,
        )
    ...
    >
      ...
      >
        ...
        >
          ...
          <Animated.View
            className="w-full rounded-[28px] bg-white px-4 py-4 shadow-xl max-h-[88%] border border-[#E5E7EB] overflow-hidden"
            style={{
              opacity: cardAnim,
              transform: [
                {
          ...
          >
            ...
            >
              <View className="mb-4 rounded-[26px] border border-[#DBEAFE] bg-[#F8FBFF] p-4">
                <View className="rounded-[24px] border border-[#DBEAFE] bg-white/90 px-4 py-4">
                  <View className="flex-row items-start justify-between gap-3">
                    <View className="flex-1 min-w-0 pr-2">
                      <View className="flex-row items-center gap-2">
                        <View className="h-7 w-7 items-center justify-center rounded-2xl bg-[#EFF6FF] border border-[#BFDBFE]">
                          <Ionicons
                            name="notifications"
                            size={13}
                            color="#1D4ED8"
                        ...
                        <Text className="text-[10px] uppercase font-semibold tracking-[0.2em] text-[#1D4ED8]">
                          Protocolo
                        </Text>
                      </View>
                      <Text
                        className="mt-2 text-[18px] leading-6 font-bold text-[#0F172A]"
                        numberOfLines={2}
                      >
                        {protocol.title}
                      </Text>
                    ...
                    {scheduledTimeLabel ? (
                      <View className="shrink-0 min-w-[92px] rounded-2xl border border-[#BFDBFE] bg-[#EFF6FF] px-3 py-2">
                        <Text className="text-[9px] font-semibold uppercase tracking-[0.16em] text-[#1D4ED8]">
                          Hora
                        </Text>
                        <Text
                          className="mt-0.5 text-[16px] font-extrabold leading-5 text-[#0F172A]"
                          numberOfLines={1}
                        >
                          {scheduledTimeLabel}
                        </Text>
                  ...
                  <Text className="mt-3 text-sm leading-6 text-[#475569]">
                ...
                <View className="mt-4 flex-row items-center justify-between rounded-2xl bg-white px-4 py-3 border border-[#E5E7EB]">
                  <View className="flex-1 flex-row items-center gap-2 pr-3">
                    ...
                    <Text className="flex-1 text-sm font-medium text-[#374151]">
                      {scheduledTimeLabel
                        ? "Disponible desde esa hora"
              ...
              <View className="mb-4 rounded-[24px] border border-[#E5E7EB] bg-white p-4">
                <View className="flex-row items-center justify-between mb-3">
                  ...
                  <View className="items-end">
                    <Text className="text-[10px] uppercase tracking-[0.18em] text-[#9CA3AF]">
                      Hora actual
                    </Text>
                ...
                <View className="bg-white rounded-3xl p-6 shadow-xl border border-[#E5E7EB]">
                  <View className="items-center mb-5">
                    ...
                    <Text className="text-sm text-[#6B7280] text-center mt-2">
                      Confirmas que esta respuesta de protocolo quedará
                      registrada por:
                    </Text>
